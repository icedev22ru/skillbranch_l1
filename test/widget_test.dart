...
void main() {
  ...
  group('l01h06', () {
    testWidgets(
        'Top and Bottom widget have 10% padding from the edges of the screen',
        (WidgetTester tester) async {
      await tester.pumpWidget(MyApp());
      final List<Stack> stackWidgets = tester
          .widgetList<Stack>(
      ...
      final Widget? topWidget = stackWithThreeWidgets!.children.firstWhere(
          (element) =>
              element is Align &&
              element.alignment == const Alignment(0, -0.8));
  ...
  group('l01h07', () {
    testWidgets('Bottom button has correct colors for all GameStates',
        (WidgetTester tester) async {
      await tester.runAsync(() async {
        ...
        expect(
          (tester.firstWidget(find.widgetWithText(ColoredBox, "START"))
                  as ColoredBox)
              .color,
        ...
        expect(
          (tester.firstWidget(find.widgetWithText(ColoredBox, "WAIT"))
                  as ColoredBox)
              .color,
        ...
        expect(
          (tester.firstWidget(find.widgetWithText(ColoredBox, "STOP"))
                  as ColoredBox)
              .color,
